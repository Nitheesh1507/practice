...
// Implement an algorithm to determine if a string has all unique characters. What t you cannot use additional data structures?

// let str = 'kumar!@#$!';

// function findUniqecharacter (str) {
...
// }
// console.log(findUniqecharacter(str));
...
// console.log(permutationStr(str1,str2));


// let str = 'Nithish kumar Engineer';

// function replaceAnother (str){
//     let rep='20%';
//     for (let i=0;i<str.length;i++){
//         if(str[i]==' '){
...
// console.log(replaceAnother(str));
